        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full min-h-screen">
          ...
          <div className="flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex gap-4 justify-center w-full">
              <a
                href="/register"
                className="bg-purple-600 text-white px-8 py-3 hover:bg-purple-700 transition-colors text-lg font-medium"
              >
                Get Started
              </a>
              ...
              <a
                href="#learn-more"
                className="bg-white text-purple-600 px-8 py-3 border-2 border-purple-600 hover:bg-purple-50 transition-colors text-lg font-medium"
              >
                Learn More
              </a>
            </div>
